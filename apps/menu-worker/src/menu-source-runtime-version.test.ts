...
import { HTML_STRONG_TITLE_PRICE_RECOVERY_VERSION } from "./html-strong-title-price-recovery.js";
...
describe("HTML runtime extractor version", () => {
  it("tracks every extractor and runtime normalizer revision", () => {
    ...
    expect(HTML_NON_DISH_FILTER_VERSION).toBe("non-dish-v11");
    expect(HTML_BEVERAGE_FILTER_VERSION).toBe("beverage-v10");
    ...
    expect(HTML_RECOVERY_SELECTION_VERSION).toBe("recovery-selection-v3");
