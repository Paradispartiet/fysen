...
`CuisineExplorer` viser den flate, filtrerbare **Utforsk verden**-katalogen definert i `matlyst-v3.md`. Verdensdel og kulinarisk region er ikke navigasjonsnivåer; brukeren velger et av de 19 aktive kjøkkenene direkte. Italiensk, Japansk, Tyrkisk, Indisk, Kinesisk og Thai vises først som en redaksjonell popularitetstopp, mens én åpne/lukke-knapp viser resten av den samme katalogen.
