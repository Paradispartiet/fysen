...
PR #674 was replayed onto fresh canonical `main` `aeb195065dc8430db88fa4f9e427a310318b4624` before final proof. The fresh exact-head gates were green, including CI #2396, restaurant validation #908 and batch intake #546. The inspected intake artifact was `restaurant-batch-intake-b5767c1370a11af80af2c78d6c4b92c6c422a143`, digest `sha256:54605312b7cc4a088e63ca877d030f29102444a26ba89e156a69d511314fc4a6`.

Full artifact QA produced the final round-3 decisions:
...
- **Festningen Restaurant — semantic-review:** output is materially cleaner but still emits the same physical item bilingually as separate canonical dishes (`SPEKEMAT` / `CURED MEAT`). It is not promoted merely because strict validation is green.
