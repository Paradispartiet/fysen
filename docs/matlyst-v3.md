...
1. **Utforsk verden** – én direkte, filtrerbar katalog over alle aktive kjøkken, uten verdensdel eller kulinarisk region som mellomnivå. Italiensk, Japansk, Tyrkisk, Indisk, Kinesisk og Thai vises først; én knapp åpner og lukker resten av katalogen.
...
De seks første kjøkkenene er en redaksjonell popularitetstopp basert på norske bestillingsmønstre, særlig pizza, sushi, kebab, asiatisk og indisk i [Wolts nasjonale 2025-oppsummering](https://press.wolt.com/no-NO/259228-wolt-wrapped-dette-bestilte-nordmenn-hjem-i-2025/). Dette er ikke en påstand om en full befolkningsmåling. De øvrige kjøkkenene sorteres med fersk Oslo-dekning først når browse-data er tilgjengelig. `DishBrowseResponse` leverer både konservativt restaurantantall og opptil to dedupliserte restauranteksempler per rett. Live-signalene lager ikke en ny indeks og registreres ikke som brukersøk.
